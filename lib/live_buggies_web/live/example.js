...
const url =
  "https://buggy-buggies.gigalixirapp.com/api/game/82ef6d12-3b2a-4ae0-89ed-957812b6c646/player/2afa62a6-f53c-4963-a25f-500e3d5c1a55";
...
async function main() {
  ...
  const { world, you: { x, y, boom } } = resp.result;
  if (boom) return null;
  const you = `${x},${y}`;
